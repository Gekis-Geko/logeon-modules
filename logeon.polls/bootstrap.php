...
return static function ($moduleRuntime = null, $moduleManifest = null): void {
    ...
    \Core\Hooks::add('twig.slot.admin.dashboard.polls', static function ($fragments) {
        if (!is_array($fragments)) {
            $fragments = [];
        }
        $fragments[] = [
            'id' => 'polls-admin-dashboard-page',
            'template' => 'admin/pages/polls.twig',
            'after' => '',
            'before' => '',
            'data' => [],
        ];
